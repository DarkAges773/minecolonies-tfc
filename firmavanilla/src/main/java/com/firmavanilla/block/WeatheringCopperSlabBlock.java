...
/** Slab weathering copper (TFC's plated slab). See {@link WeatheringCopperBarsBlock} for the shared pattern. */
public class WeatheringCopperSlabBlock extends SlabBlock implements WeatheringCopper
{
    ...
    public WeatheringCopperSlabBlock(final WeatheringCopper.WeatherState age, final ResourceLocation tfcItem, final BlockBehaviour.Properties properties)
    {
        super(properties);
        this.age = age;
