...
/** Stairs weathering copper (TFC's plated stairs). See {@link WeatheringCopperBarsBlock} for the shared pattern. */
public class WeatheringCopperStairBlock extends StairBlock implements WeatheringCopper
{
    ...
    public WeatheringCopperStairBlock(final WeatheringCopper.WeatherState age, final ResourceLocation tfcItem, final Supplier<BlockState> baseState, final BlockBehaviour.Properties properties)
    {
