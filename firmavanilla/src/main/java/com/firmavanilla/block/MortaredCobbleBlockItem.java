 ...
 * keys; a plain {@code BlockItem} would show its raw {@code block.firmavanilla.mortared.<…>} description id in
 * the inventory/tooltip. Delegating the item name to {@link MortaredCobbleBlock#getName()} ("Cemented
 * &lt;source&gt;") gives a sensible display name everywhere with no per-twin lang entry.
 */
